...
const BentoGrid = ({
  ...
  return (
    <div
      className={cn(
        "grid auto-rows-[22rem] grid-cols-2 gap-4",
        className,
      )}
    >
      {children}
...
const BentoCard = ({
  ...
  <div
    ...
    className={cn(
      ...
      // dark styles
      "transform-gpu dark:bg-green-900 dark:[border:1px_solid_rgba(255,255,255,.1)] dark:[box-shadow:0_-20px_80px_-20px_#ffffff1f_inset]",
      className,
    )}
  >
    <div>{background}</div>
    <div className="pointer-events-none z-10 flex transform-gpu flex-col gap-1 p-6 transition-all duration-300 group-hover:-translate-y-10">
      ...
      <h3 className="text-xl font-semibold text-neutral-400 dark:text-neutral-300">
        {name}
      </h3>
